...
CPP_POLICIES = {"fifo", "lru", "optimal"}
KNOWN_POLICIES = CPP_POLICIES | {"custom"}
...
def run_sweep(
    ...
    *,
    ...
    for policy in selected_policies:
        ...
        if backend == "cpp" and policy not in CPP_POLICIES:
            raise ValueError(f"Policy '{policy}' is implemented in Python only; rerun with --backend python")
